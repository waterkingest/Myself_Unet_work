...
def List_predict():
    ...
    savepath='F:\\exciseData\\result\\Deeplab\\'
...
def single_predict():
    while True:
        ...
        try:
            ...
            r_image.show()
def merge_predict():
    imagepath='F:\\exciseData\\testimage'
        ...
        if i.endswith('.tif') :
            ...
            for i in range(1,num+1):
                for j in range(1,num+1):                  
                    ...
                    l1img=Image.fromarray(np.uint8(l1img))
                    r_image=unet.detect_image(l1img)
            ...
            print(savepath2,' 已完成 {:.2f}% '.format(name/total*100))
            # break
    print('finish!')
