...
from nets.deeplab import DeepLab as deeplab
...
class DeepLab(object):
    _defaults = {
        "model_path"        : 'logs\Deeplab_water\Epoch25-Total_Loss0.2800-Val_Loss0.2755.pth',
    ...
    def generate(self):
        ...
        self.net = deeplab(num_classes=self.num_classes).eval()
